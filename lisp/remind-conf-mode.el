...
(defun regexp-opt-allcase (l s)
  (regexp-opt (append (mapcar 'downcase l) l) s))

(defconst remind-conf-font-lock-keywords-1
  (list
   '("^[\;\#]+.*$" . remind-comment-face)
   (cons (regexp-opt-allcase remind-keywords 'words) remind-conf-keyword-face)
...
(defconst remind-conf-font-lock-keywords-2
  (append remind-conf-font-lock-keywords-1
	  (list
	   (cons (regexp-opt-allcase remind-time-words 'words) remind-time-face)
	   (cons (regexp-opt-allcase remind-builtin-functions 'words) remind-conf-command-face)
...
(defconst remind-conf-font-lock-keywords-3
  (append remind-conf-font-lock-keywords-2
	  (list
	   (cons (regexp-opt-allcase remind-type-keywords 'words) remind-conf-type-face)
	   ...
	   (cons (regexp-opt-allcase remind-builtin-variables 'words) remind-conf-variable-face)))
